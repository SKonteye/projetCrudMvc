				...
				<div class="col-sm-6">
					...
					<form method="post">
						...
						<div class="form-group">
							...
							<input type="email" name="prenom" id="prenom" class="form-control" value="<?php echo $row[0]['prenom']; ?>" placeholder="Enter user email" required>
						</div>
						<div class="form-group">
							<label>User Phone <span class="text-danger">*</span></label>
							<input type="tel" name="classe" id="classe" maxlength="12" class="form-control" value="<?php echo $row[0]['classe']; ?>" placeholder="Enter user phone" required>
						</div>
						<div class="form-group">
