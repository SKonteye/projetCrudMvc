...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	if($nom==""){
		...
		$etudiantDAO = new EtudiantDAOImpl($conn);
		$etudiantController = new EtudiantController($etudiantDAO);
	...
	<div class="container my-4">
   	...
   	<div class="container">
		...
		if(isset($_REQUEST['msg']) and $_REQUEST['msg']=="un"){
			...
			echo	'<div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> Etudiant name is mandatory field!</div>';

		}elseif(isset($_REQUEST['msg']) and $_REQUEST['msg']=="ue"){

			echo	'<div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> Etudiant email is mandatory field!</div>';

		}elseif(isset($_REQUEST['msg']) and $_REQUEST['msg']=="up"){

			echo	'<div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> Etudiant phone is mandatory field!</div>';
				...
				<div class="col-sm-6">
					...
					<form action="index.php?action=create" method="post">
						...
						<div class="form-group">
							...
							<input type="text" name="nom" id="nom" class="form-control" placeholder="Enter user name" required>
						...
						<div class="form-group">
							...
							<input type="text" name="prenom" id="prenom" class="form-control" placeholder="Enter user email" required>
						...
						<div class="form-group">
							...
							<input type="text" name="classe" id="classe" class="form-control" placeholder="Enter level" required>

						</div>
						<div class="form-group">

							<label>Classe Id<span class="text-danger">*</span></label>

							<input type="text" name="salle_id" id="salle_id" class="form-control" placeholder="Enter class" required>

						</div>

						<div class="form-group">

							<button type="submit" name="submit" value="submit" id="submit" class="btn btn-primary"><i class="fa fa-fw fa-plus-circle"></i> Add Etudiant</button>
